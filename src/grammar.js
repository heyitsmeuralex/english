...
var grammar = {
    ...
    {"name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id},
    {"name": "Program$ebnf$1$subexpression$1$ebnf$1", "symbols": ["_program"]},
    {"name": "Program$ebnf$1$subexpression$1$ebnf$1", "symbols": ["_program", "Program$ebnf$1$subexpression$1$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "Program$ebnf$1$subexpression$1", "symbols": ["Program$ebnf$1$subexpression$1$ebnf$1", "_"]},
    ...
    {"name": "_program", "symbols": ["Command", "_program$ebnf$1"], "postprocess": function(d, _, reject) { if(d[0][0][0] !== C.PLAIN) return reject; return [d[0], ...d[d.length - 1]] }},
