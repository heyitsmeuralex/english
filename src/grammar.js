...
var grammar = {
    ...
    {"name": "_program", "symbols": ["Command", "_program$ebnf$1", "__", "_program"], "postprocess": function(d, _, reject) { if(d[0][0][0] !== C.PLAIN) return reject; return [d[0], ...d[d.length - 1]] }},
    ...
    {"name": "CommandSeperator$string$2", "symbols": [{"literal":"A"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$2"]},
    {"name": "CommandSeperator$string$3", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$3"]},
    {"name": "CommandSeperator$string$4", "symbols": [{"literal":"T"}, {"literal":"h"}, {"literal":"e"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$4"]},
    {"name": "CommandSeperator$string$5", "symbols": [{"literal":"f"}, {"literal":"i"}, {"literal":"n"}, {"literal":"a"}, {"literal":"l"}, {"literal":"l"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$5"]},
    {"name": "CommandSeperator$string$6", "symbols": [{"literal":"F"}, {"literal":"i"}, {"literal":"n"}, {"literal":"a"}, {"literal":"l"}, {"literal":"l"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$6"]},
    {"name": "CommandSeperator$string$7", "symbols": [{"literal":"l"}, {"literal":"a"}, {"literal":"s"}, {"literal":"t"}, {"literal":"l"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$7"]},
    {"name": "CommandSeperator$string$8", "symbols": [{"literal":"L"}, {"literal":"a"}, {"literal":"s"}, {"literal":"t"}, {"literal":"l"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$8"]},
    {"name": "CommandSeperator$string$9", "symbols": [{"literal":"n"}, {"literal":"e"}, {"literal":"x"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$9"]},
    {"name": "CommandSeperator$string$10", "symbols": [{"literal":"N"}, {"literal":"e"}, {"literal":"x"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$10"]},
    {"name": "CommandSeperator$string$11", "symbols": [{"literal":"a"}, {"literal":"l"}, {"literal":"s"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$11"]},
    {"name": "CommandSeperator$string$12", "symbols": [{"literal":"A"}, {"literal":"l"}, {"literal":"s"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CommandSeperator", "symbols": ["__", "CommandSeperator$string$12"]},
